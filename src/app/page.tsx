  ...
  return (
    <main className="min-h-screen text-white font-sans" style={{ backgroundColor: '#9A9580' }}>
      ...
      <section className="py-12 px-6 flex flex-col items-center">
          ...
          >
            ...
            >
              <img
                ...
                alt="Stefania Dolak — Visitenkarte"
            ...
            >
              <img
                ...
                alt="Kommunikations Management — Logo"
                className="w-full h-full object-cover"
              />
            </div>
          </div>
        ...
        <p className="text-center text-xs text-white/50 mt-6 tracking-wider">
          Zum Umdrehen tippen
        </p>
      </section>
      ...
      {/* CHARAKTER */}
      <section id="charakter" className="py-16 px-6" style={{ backgroundColor: '#8E8875' }}>
        <div className="max-w-2xl mx-auto text-center space-y-8">
      ...
      {/* SPECIALS — Meine Überzeugung (langer Profil-Text) */}
      <section className="py-16 px-6" style={{ backgroundColor: '#8E8875' }}>
        <div className="max-w-2xl mx-auto text-center space-y-8">
